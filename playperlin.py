    ...
    for x in range(ranlen):
        ...
        for z in range((ranlen)):
            ...
            if ranbiome == 1:
                ...
                mc.setBlocks(x+offset,y-2,z+ranz,x+offset,y-amp/4+noise([x/freq,z/freq]),z+ranz,1)
                mc.setBlock(xloc,y+1,zloc,2)
                mc.setBlocks(x+offset,y,z+ranz,x+offset,y-2,z+ranz,3)
                ...
                if rantree == 2:
                    ...
                    mc.setBlocks(x+offset,y+2,z+ranz,x+offset,y+8,z+ranz,17)
            ...
            if ranbiome == 2:
                #print('desert biome')
                #y = 0
                y = noise([x/freq,z/freq]) * 2
                mc.setBlocks(x+offset,y,z+ranz,x+offset,y-5+noise([x/freq,z/freq]) * 20,z+ranz,1)
